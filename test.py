...
if __name__ == '__main__':
    ...
    use_cuda = args.cuda = False and torch.cuda.is_available()
    ...
    pretrained_dict = torch.load(config.pretrained_path, map_location=torch.device('cpu')) # , map_location=torch.device('cpu') è stata aggiunta
